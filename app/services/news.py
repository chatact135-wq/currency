...
def get(asset):
    ...
    try:
        ...
        return {"connected": False, "score": 0, "bias": "neutral", "headlines": [], "explanation": str(exc), "news_countdown": countdown}
    ...
    for article in data.get("articles", []):
        ...
        score, h = score_text(title + " " + desc)
        total += score
        hits += h
        headlines.append({"title": title[:150], "source": (article.get("source") or {}).get("name", ""), "score": score})
